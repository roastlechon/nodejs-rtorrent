...
Deserializer.prototype.endNil = function () {
  this.push(null);
  this.value = false;
};
...
Deserializer.prototype.endParams = function () {
  this.responseType = 'params';
};

Deserializer.prototype.endFault = function () {
  this.responseType = 'fault';
};

Deserializer.prototype.endMethodResponse = function () {
...
Deserializer.prototype.endMethodCall = function () {
